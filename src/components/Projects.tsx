...
export const Projects: React.FC = () => {
  ...
  return (
    <section id="projects" className="py-24 border-b border-zinc-200/80 dark:border-zinc-800/80 bg-white/60 dark:bg-zinc-900/30 transition-colors duration-200">
